...
\task [right = of rpctrace] {Traced Task 2}{}{sl}{}
\task [above = of Traced Task 2] {Traced Task 1}{}{sl}{}
\task [below = of Traced Task 2] {Traced Task 3}{}{sl}{}

\task [above = of rpctrace] {Unknown Task}{}{sl}{}

\draw [port link] (rpctrace Left Port 0) -- +(-1,0) |- (Unknown Task Port 0);
\draw [port link] (Traced Task 2 Port 0) -- (rpctrace Right Port 0);
\draw [port link] (Traced Task 1 Port 0) -| ($(Traced Task 1 Port 0)!.5!(rpctrace Right Port 5)$) |- (rpctrace Right Port 5);
...
\node (Unknown Task recvright) at (Unknown Task Port 0) [recv, anchor=west] {R};
